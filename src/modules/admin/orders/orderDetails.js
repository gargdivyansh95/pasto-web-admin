                        ...
                        {isLoading ? (
                            ...
                            <>
                                ...
                                {orderDetails?.isSelfOrder ? (
                                    <Badge
                                        className={`text-white text-sm font-medium absolute top-0 left-0 rounded-none rounded-tl-xl rounded-br-xl ${orderDetails?.isPaid ? "bg-[#34C759]" : "bg-brand-red"}`}
                                    >
                                        {orderDetails?.isPaid ? "Paid" : "Not Paid"}
                                    </Badge>
                                ) : (
                                    <Badge
                                        className={`text-white text-sm font-medium absolute top-0 left-0 rounded-none rounded-tl-xl rounded-br-xl ${orderDetails?.isSelfPickup ? "bg-[#00C7BE]" : "bg-[#34C759]"}`}
                                    >
                                ...
                                <CardContent className="px-0">
                                    <div className="flex items-center justify-between gap-4">
                                        ...
                                        <div className="flex items-center gap-2 mb-4">
                                            ...
                                            <Badge className="text-white text-sm font-medium rounded"
                                    ...
                                    {orderDetails?.orderItems?.map((item, index) => (
                                        <div key={index} className="border p-3 rounded-md mb-4">
                                            <div className="flex items-center gap-4">
                                                <Image src={item?.itemImage || NoImage} width={140} height={140} alt="Restaurant"
                                                    ...
                                                    <TableBody>
                                                        {item?.optionSize?.map((ele, idx) => (
                                                            <TableRow key={idx}>
                                                                ...
                                                                <TableCell>₹{ele?.totalPrice}</TableCell>
                                                            </TableRow>
                                                        ))}
                                                    </TableBody>
                                                </Table>
                                    ...
                                    <DetailCard label="Cooking Instructions" value={orderDetails?.cookingInstructions || "N/A"} />
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <DetailCard
                                            ...
                                            value={
                                                orderDetails?.isSelfPickup || orderDetails?.isSelfOrder
                                                    ? formatTime(orderDetails?.orderStatus?.readyForPickupAt)
                                                    : formatTime(orderDetails?.orderStatus?.outForDeliveryAt)
                                            }
                                        />
                        ...
                        {isLoading ? (
                            ...
                            <>
                                ...
                                <CardContent className="px-0">
                                    ...
                                    <DetailCard label="Customer Name" value={orderDetails?.userDetails?.name || "N/A"} />
                                    <DetailCard label="Customer Contact Number" value={orderDetails?.userDetails?.phoneNumber || "N/A"} />
                                    <DetailCard label="Customer Address" value={orderDetails?.deliveryAddress || "N/A"} />
                                </CardContent>
                            </>
                        )}
                    </Card>
